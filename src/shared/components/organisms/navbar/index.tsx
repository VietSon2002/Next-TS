  ...
  return (
    <header>
      ...
      <div className="header-top flex justify-between">
        <ContactInfoItem icon="icon-phone">(528) 456–7592</ContactInfoItem>
        <div className="flex gap-4">
          <ContactInfoItem icon="icon-email">info@example.com</ContactInfoItem>
          <ContactInfoItem icon="icon-clock">Mon - Fri 10:00 to 6:00</ContactInfoItem>
        </div>
      </div>
